...
RfuBot=[lineMID]
Family=["uc2cc488983ba1815b11e9d12707a8495",lineMID]
admin = "uc2cc488983ba1815b11e9d12707a8495" 
admin=['uc2cc488983ba1815b11e9d12707a8495',lineMID]
...
settings = {
    ...
    "man2":"",
    "man3":"",
    "message":"บัญชีนี้ได้การป้องกันโดย iDo ระบบได้ทำการบล็อคคุณอัตโนมัติ",
...
def helptexttospeech():
    helpTextToSpeech =   """❋►คำสั่งเลียนแบบ⍣By.BotSelf⍣
❇ เลียนแบบ on/off 
❇ เลียนแบบ 
❇ เพิ่มเลียนแบบ (@) 
❇ ลบเลียนแบบ (@)"""
...
def helplanguange():
    helpLanguange =    """คำสั่งล่องหน⍣By.BotSelf⍣
ℹ!แทค
ℹ!มิด
ℹ!คท"""
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    ki.sendMessage(to, "Server Send [TEST]")
                elif text.lower() == 'เทส':
                    ...
                    line.sendMessage(to, "เวลา Online\n""ระยะเวลาการทำงานของบอท {}".format(str(runtime)))
                elif text.lower() == 'บอท':
                    try:
                        arr = []
                        owner = "uc2cc488983ba1815b11e9d12707a8495"
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "uc2cc488983ba1815b11e9d12707a8495")
                elif text.lower() == 'มิด':
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["เขียว","บวก","ถูก","รวย","เราถูกหวย","เขียวๆ","รวยๆ","แตกจ้า","แตก"]:
                    line.sendText(msg.to,"ดีใจด้วยคนน๊าาา!!...😝😝")				
